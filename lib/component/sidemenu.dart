...
import 'package:you_move_me/component/sidemenubar.dart';
import 'package:you_move_me/utils/helpers.dart';
import 'package:you_move_me/constant/slidedrection.dart';
...
class SliderMenuContainer extends StatefulWidget {
  ...
  const SliderMenuContainer({
    ...
    this.appBarPadding = const EdgeInsets.only(top: 0),
