...
import 'package:you_move_me/UI/home/career_tab/components/chart.dart';
...
class SummaryTab extends StatelessWidget {
  int totalquestion;
  SummaryTab({Key? key, required this.totalquestion}) : super(key: key);
  @override
              ...
              child: Row(
                children: [
                  CommonButton(
                    isExpanded: true,
                    ontap: () {
                      Navigator.pushNamed(context, Routes.congrat_Tab);
                    },
                    lable: "Submit",
                  ),
                ],
